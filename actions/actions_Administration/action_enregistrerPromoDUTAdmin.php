...
$requeteRespDUT = "UPDATE enseignant,promotion SET enseignant.responsable =0 WHERE (promotion.nom='DUT') AND (promotion.loginResp=enseignant.login)";
//maj
...
$requeteMajTIC = "UPDATE enseignant,promotion SET enseignant.responsable =1 WHERE (promotion.nom='TIC') AND (promotion.loginResp=enseignant.login)";
...
$notification = "Promotion DUT modifiée";
