...
if ($ds){
   ...
   $uid="(&(supannetudiplome={SISE}2003096)(supannetucursusannee={SUPANN}L1))";
...
for ($i=0; $i<$info["count"]; $i++){
	...
	$connexion->query("INSERT INTO etudiant VALUES('$login','$nom','$prenom',0,'LP')");
...
{
    $notification= "Impossible de se connecter au serveur LDAP, la promotion de LP SIL n'a pas pu être importée.";
}




$notification="La promotion de LP SIL a bien été modifiée";
