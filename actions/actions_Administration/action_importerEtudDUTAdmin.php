...
if ($ds){
   ...
   $uid="(&(supannetudiplome={SISE}1000293)(supannetucursusannee={SUPANN}L2)(supannetucursusannee={SUPANN}B2)(supannetucursusannee={SUPANN}ABTIN4))";
...
for ($i=0; $i<$info["count"]; $i++){
	...
	$connexion->query("INSERT INTO etudiant VALUES('$login','$nom','$prenom',0,'DUT')");
...
{
    $notification= "Impossible de se connecter au serveur LDAP, la promotion de DUT Informatique n'a pas pu être importé.";
}




$notification="La promotion de DUT Informatique a bien été modifiée";
